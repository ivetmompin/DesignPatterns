...
public class GironaPizza implements Pizza {
    private Crust crust;
    private List<Ingredient> ingredients ;
    private List<Integer> quantities;

    public GironaPizza(Crust crust){
        System.out.print("""
                
                -------------Girona Pizza Configuration-------------
    ...
    public void updateQuantities() {
        ...
        System.out.println("Updating quantities for Girona pizza...");
